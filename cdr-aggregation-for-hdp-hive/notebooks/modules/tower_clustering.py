...
class tower_clusterer:
    ...
    def __init__(self,
        ...
        #Saurav
        sites_df=sites_df[['cell_id', 'LAT', 'LNG']]
    ...
    def cluster_towers(self):
        ...
        ## Saurav
        #self.sites = self.sites[self.sites[self.sites.LAC.notna()]]
        #self.sites['LAC'] = self.sites['LAC'].astype('int64')
        #self.sites['CELL_ID'] = self.sites['LAC'].map(str) + ':' + self.sites['CELL_ID'].map(str)
        ##
        ...
        print('Distance Cluster Completed')
